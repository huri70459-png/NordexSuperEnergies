  ...
  return (
    <section className="relative w-full overflow-x-clip bg-background">
      <div className="relative min-h-[min(92svh,52rem)] w-full overflow-hidden">
        ...
        <div className="relative z-10 flex min-h-[min(92svh,52rem)] flex-col justify-end px-[max(var(--section-x),var(--safe-left))] pr-[max(var(--section-x),var(--safe-right))] pb-12 pt-28 sm:pb-16 sm:pt-32 md:pb-20">
          <div className="nx-container max-w-3xl">
            <FadeUp>
              <p className="nx-eyebrow text-white/75">{homeHero.eyebrow}</p>
              <h1 className="mt-4 text-balance text-[clamp(2.25rem,6vw,3.75rem)] font-medium leading-[1.05] tracking-tight text-white">
                {homeHero.headline}
              </h1>
