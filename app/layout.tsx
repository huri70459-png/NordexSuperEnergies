...
export const metadata: Metadata = {
  title: {
    default: "Nordex Super Energies",
    template: "%s | Nordex Super Energies",
  },
  description:
    "Nordex Super Energies — energy systems across the value chain, with a curated antiques collection.",
  applicationName: "Nordex Super Energies",
  appleWebApp: {
    capable: true,
...
/** Multi-device viewport: notch-safe, no accidental zoom traps, dynamic toolbars. */
